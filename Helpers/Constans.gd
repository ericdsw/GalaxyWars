...
const STATION_MANAGER_MISSILE_INITIAL_AMOUNT = 0
const STATION_MANAGER_LASER_INITIAL_AMOUNT = 0
const STATION_MANAGER_SHIELD_INITIAL_AMOUNT = 0
const STATION_MANAGER_WINGS_INITIAL_AMOUNT = 0

const PLAYER_SCRAP_DEFAULT_DEPOSIT_AMOUNT = 1
const PLAYER_MISSILE_INITIAL_AMOUNT = 4
