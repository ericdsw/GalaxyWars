...
const PLAYER_SHOCKED_TIME = 0.75 
...
const STATION_STARTING_HP = 2000
const STATION_SHIP_COOLDOWN = 5
const STATION_MANAGER_ECONOMY_INITIAL_AMOUNT = 0
const STATION_MANAGER_ECONOMY_AMOUNT_TO_LEVEL_UP = 12
...
const POWER_UP_SCRAP_AMOUNT_FOR_MISSILE = 6
const POWER_UP_SCRAP_AMOUNT_FOR_LASER = 6
const POWER_UP_SCRAP_AMOUNT_FOR_SHIELD = 6
const POWER_UP_SCRAP_AMOUNT_FOR_WINGS = 6

# Base stats for battleship
var BATTLESHIP_MAX_HP = 300
...
const LASER_FIRE_RATE = 4
const LASER_FIRE_RATE_VARIANCE = 2

# Percentage of hp the shield covers and how much it increments per level (additive)
var SHIELD_COVERAGE = 0.4
const SHIELD_COVERAGE_PER_LEVEL = 0.2
...
const MULTIPLIER_BULLET_TO_SHIELD = 0.2
const MULTIPLIER_BULLET_TO_TOWER = 1.0
const MULTIPLIER_MISSILE_TO_SHIP = 1.2
const MULTIPLIER_MISSILE_TO_SHIELD = 0.3
